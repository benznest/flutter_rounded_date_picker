...
class _CupertinoDatePickerDateState extends State<FlutterRoundedCupertinoDatePickerWidget> {
  ...
  void didChangeDependencies() {
    ...
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] = FlutterRoundedCupertinoDatePickerWidget._getColumnWidth(_PickerColumnType.dayOfMonth, localizations, context);
    estimatedColumnWidths[_PickerColumnType.month.index] = FlutterRoundedCupertinoDatePickerWidget._getColumnWidth(_PickerColumnType.month, localizations, context);
    estimatedColumnWidths[_PickerColumnType.year.index] = FlutterRoundedCupertinoDatePickerWidget._getColumnWidth(_PickerColumnType.year, localizations, context);
  }
      ...
      children: List<Widget>.generate(31, (int index) {
        ...
        return itemPositioningBuilder(
          ...
          Text(
            ...
            style: textStyle.copyWith(fontFamily: widget.fontFamily),
          ),
        );
      }),
      looping: true,
  ...
  Widget _buildMonthPicker(double offAxisFraction, TransitionBuilder itemPositioningBuilder) {
    return CupertinoPicker(
      ...
      children: List<Widget>.generate(12, (int index) {
        return itemPositioningBuilder(
          context,
          Text(localizations.datePickerMonth(index + 1), style: _themeTextStyle(context).copyWith(fontFamily: widget.fontFamily)),
        );
      }),
      looping: true,
    );
    ...
    return CupertinoPicker.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return itemPositioningBuilder(
          ...
          Text(
            strYear,
            style: _themeTextStyle(context).copyWith(fontFamily: widget.fontFamily),
          ),
        );
      },
    );
  ...
  Widget build(BuildContext context) {
    ...
    switch (localizations.datePickerDateOrder) {
      case DatePickerDateOrder.mdy:
        ...
        columnWidths = <double>[estimatedColumnWidths[_PickerColumnType.month.index], estimatedColumnWidths[_PickerColumnType.dayOfMonth.index], estimatedColumnWidths[_PickerColumnType.year.index]];
        break;
      case DatePickerDateOrder.dmy:
        pickerBuilders = <_ColumnBuilder>[_buildDayPicker, _buildMonthPicker, _buildYearPicker];
        columnWidths = <double>[estimatedColumnWidths[_PickerColumnType.dayOfMonth.index], estimatedColumnWidths[_PickerColumnType.month.index], estimatedColumnWidths[_PickerColumnType.year.index]];
        break;
      case DatePickerDateOrder.ymd:
        pickerBuilders = <_ColumnBuilder>[_buildYearPicker, _buildMonthPicker, _buildDayPicker];
        columnWidths = <double>[estimatedColumnWidths[_PickerColumnType.year.index], estimatedColumnWidths[_PickerColumnType.month.index], estimatedColumnWidths[_PickerColumnType.dayOfMonth.index]];
        break;
      case DatePickerDateOrder.ydm:
        pickerBuilders = <_ColumnBuilder>[_buildYearPicker, _buildDayPicker, _buildMonthPicker];
        columnWidths = <double>[estimatedColumnWidths[_PickerColumnType.year.index], estimatedColumnWidths[_PickerColumnType.dayOfMonth.index], estimatedColumnWidths[_PickerColumnType.month.index]];
        break;
      default:
